...
#
import os.path  # TODO: instead of import os, import "os.path"
import sys
...
copyright = '2023, Markus Schuster'
...
# ones.
extensions = ['sphinx.ext.autodoc', 'sphinx.ext.githubpages', 'sphinx.ext.graphviz', 'sphinxcontrib.plantuml']
...
# Define the PlantUML path (optional, if not in PATH)
